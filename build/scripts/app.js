...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component('tab', {
  template: `
...
const mask = Object(imask__WEBPACK_IMPORTED_MODULE_1__["default"])(input, {
...
const ajaxSend = formData => {
  ...
  }).then(response => alert('Сообщение отправлено')).catch(error => console.error(error));
};
